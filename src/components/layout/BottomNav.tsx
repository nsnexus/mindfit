...
export function BottomNav() {
  ...
  return (
    <nav className="lg:hidden fixed bottom-0 left-0 right-0 z-40 bg-white/90 backdrop-blur-2xl border-t border-[#eef4f1] px-2 py-2 shadow-[0_-8px_30px_rgba(0,0,0,0.08)]">
        ...
        {MOBILE_NAV_ITEMS.map((item) => {
          ...
          return (
            ...
            >
              ...
              <span className="text-[10px] tracking-tight font-head">{item.label}</span>
              {isActive && (
